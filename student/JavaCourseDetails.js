...
export default function JavaCourseDetails({ course, onBack }) {
  return (
    <LinearGradient
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.iconCircleSmall}>
            <FontAwesome5 name="js" size={18} color="#000" />
          </View>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Card style={styles.banner}>
            ...
            <View style={styles.iconCircle}>
              <FontAwesome5 name="js" size={28} color="#000" />
            </View>

            <View style={{ marginLeft: 12 }}>
              <Text style={styles.bannerTitle}>JavaScript</Text>
          ...
          <Card style={styles.rowBetween}>
            <View>
              <Text style={styles.lessonTitle}>Functions & Scope</Text>
          ...
          <View style={styles.row}>
            <Card style={styles.practiceCard}>
              ...
              <Text style={styles.practiceTitle}>JS Quiz</Text>
